    ...
    func:function() {
        ...
        new G.Unit({
            ...
            modes: {
                ...
                'necromancy':{name:'Ressurect corpses', icon:[14,1], desc:'Using [necromancy], a [shaman] can ressurect [corpse, dead] people back to life.<>Use 5 [faith].', req:{'necromancy':true}},
            },
            effects:[
                ...
                {type:'convert', from:{'corpse':1, 'faith':5}, into:{'adult':1}, chance:1/10, every:10, mode:'necromancy'},
            ],
        ...
        new G.Tech({
            name:'necromancy',
            desc:'@unlocks a new option for [shaman]s<>',
            icon:[14,1],
